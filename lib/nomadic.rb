...
<link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
  ...
  <datalist id='cmds'>
    ...
    <p id='t' class='i' style='width: 100%; text-align: center; margin: 0;'>
      <button id='t_l' type='button' class='material-icons do form' name='do' value='send'>check_box_outline_blank</button> 
      <input class='form' id='t_c' name='cat' list="cats" style='width: 65%; text-align: center;' value='nomadic'>
      <button id='t_r' type='button' class='material-icons do form' name='do' value='send'>check_box_outline_blank</button>
    </p>
   ...
   <p id='b' class='i' style='width: 100%; text-align: center; margin: 0; position: absolute; bottom: 0;'> 
      <button id='b_l' type='button' class='material-icons do form' name='do' value='send'>check_box_outline_blank</button>
      <input class='form' id='b_c' name='cmd' list="cmds" style='width: 65%;' placeholder='try me out...'>
      <button id='b_r' type='button' class='material-icons do form' name='do' value='send'>check_box_outline_blank</button>
    </p> 
  </form>
  <script>
